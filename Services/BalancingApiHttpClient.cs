...
{
    public class BalancingApiHttpClient(HttpClient httpClient, string baseUrl) : IBalancingApiHttpClient
    {
        ...
        {
            var response = await httpClient.GetAsync($"{_baseUrl}/{relativeUrl}");
